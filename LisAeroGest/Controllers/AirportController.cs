...
namespace LisAeroGest.Controllers
{
    ...
    public class AirportController : Controller
    {
        ...
        public AirportController(IAirportRepository airportRepository, IImageHelper imageHelper)
        {
        ...
        public async Task<IActionResult> Edit(AirportViewModel model)
        {
...

            {
                ...
                airport.ImageId = await _imageHelper.UploadImageAsync(model.ImageFile, "airports");
